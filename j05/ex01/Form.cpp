...
//   Updated: 2016/09/10 22:20:00 by vklaouse         ###   ########.fr       //
//                                                                            //
// ************************************************************************** //

#include "Form.hpp"

Form::Form() : _Name(""), _Gradesign(1), _Exc(1), _Signed(false)
{
}

Form::Form(std::string name, int grade, int exc) : _Name(name), _Gradesign(grade), _Exc(exc), _Signed(false)
{
}
